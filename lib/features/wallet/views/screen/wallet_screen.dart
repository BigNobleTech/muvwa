...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget _divider(ThemeData theme) => VerticalDivider(
    width: 1,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 2),
                  Text(
                    Helpers.currency(wallet.dueValue),
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                      color: AppColors.danger,
                  ...
                  if (hasLimit) ...[
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        value: (wallet.dueValue / wallet.dueLimitValue).clamp(
                          0.0,
                          1.0,
                        ),
                        minHeight: 4,
