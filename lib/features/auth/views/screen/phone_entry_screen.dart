        ...
        children: [
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text(
                        ConfigService.getCached().flagEmoji,
                        style: const TextStyle(fontSize: 18),
                      ),
                      const SizedBox(width: 6),
                      Text(
                        ConfigService.getCached().phoneCode,
                        style: TextStyle(
                          color: Theme.of(context).colorScheme.onSurface,
                        ),
                      ),
          ...
          Row(
            ...
            children: [
              ...
              _feature(Icons.chat_bubble_outline, 'auth.otp_verification'.tr()),
...
class _LanguageChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (context) => [
        PopupMenuItem(value: 'en', child: Text('settings.english'.tr())),
        PopupMenuItem(value: 'ar', child: Text('settings.arabic'.tr())),
      ],
